...
42:                                               ; preds = %39
  %43 = and i64 ptrtoint (ptr @out_buff_1 to i64), 31
  %44 = icmp eq i64 %43, 0
  call void @llvm.assume(i1 %44)
  %45 = and i64 ptrtoint (ptr @infactor_cons_buff_0 to i64), 31
  %46 = icmp eq i64 %45, 0
  call void @llvm.assume(i1 %46)
  %47 = and i64 ptrtoint (ptr @in_cons_buff_1 to i64), 31
  %48 = icmp eq i64 %47, 0
  ...
  call void @llvm.aie2.acquire(i32 52, i32 -1)
  call void @llvm.aie2.acquire(i32 49, i32 -1)
  %49 = and i64 ptrtoint (ptr @out_buff_0 to i64), 31
  %50 = icmp eq i64 %49, 0
  call void @llvm.assume(i1 %50)
  call void @llvm.assume(i1 %46)
  %51 = and i64 ptrtoint (ptr @in_cons_buff_0 to i64), 31
  %52 = icmp eq i64 %51, 0
