module attributes {llvm.target_triple = "aie2"} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    llvm.call @vector_scalar_mul_aie_scalar(%32, %24, %28, %16) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
    ...
    llvm.call @vector_scalar_mul_aie_scalar(%40, %36, %28, %16) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.call @llvm.aie2.release(%11, %15) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%10, %15) : (i32, i32) -> ()
  ...
  ^bb7:  // pred: ^bb6
    ...
    %55 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x i32>
    %56 = llvm.ptrtoint %55 : !llvm.ptr to i64
    %57 = llvm.and %56, %5  : i64
    %58 = llvm.icmp "eq" %57, %19 : i64
    "llvm.intr.assume"(%58) : (i1) -> ()
    llvm.call @vector_scalar_mul_aie_scalar(%55, %47, %51, %16) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.call @llvm.aie2.release(%11, %15) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%10, %15) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%13, %18) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%12, %18) : (i32, i32) -> ()
    ...
    llvm.call @vector_scalar_mul_aie_scalar(%63, %59, %51, %16) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.call @llvm.aie2.release(%11, %15) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%10, %15) : (i32, i32) -> ()
  ...
  ^bb11:  // pred: ^bb10
    ...
    %79 = llvm.getelementptr %1[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x i32>
    %80 = llvm.ptrtoint %79 : !llvm.ptr to i64
    %81 = llvm.and %80, %5  : i64
    %82 = llvm.icmp "eq" %81, %19 : i64
    "llvm.intr.assume"(%82) : (i1) -> ()
    llvm.call @vector_scalar_mul_aie_scalar(%79, %71, %75, %16) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.call @llvm.aie2.release(%11, %15) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%10, %15) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%13, %18) : (i32, i32) -> ()
    llvm.call @llvm.aie2.acquire(%12, %18) : (i32, i32) -> ()
    %83 = llvm.getelementptr %6[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x i32>
    %84 = llvm.ptrtoint %83 : !llvm.ptr to i64
    %85 = llvm.and %84, %5  : i64
    %86 = llvm.icmp "eq" %85, %19 : i64
    "llvm.intr.assume"(%86) : (i1) -> ()
    "llvm.intr.assume"(%78) : (i1) -> ()
    %87 = llvm.getelementptr %3[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<1024 x i32>
    %88 = llvm.ptrtoint %87 : !llvm.ptr to i64
    %89 = llvm.and %88, %5  : i64
    %90 = llvm.icmp "eq" %89, %19 : i64
    "llvm.intr.assume"(%90) : (i1) -> ()
    llvm.call @vector_scalar_mul_aie_scalar(%87, %83, %75, %16) : (!llvm.ptr, !llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.call @llvm.aie2.release(%11, %15) : (i32, i32) -> ()
    llvm.call @llvm.aie2.release(%10, %15) : (i32, i32) -> ()
